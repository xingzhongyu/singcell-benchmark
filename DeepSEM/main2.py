...
parser.add_argument('--data_file', type=str, default='./demo_data/GRN_inference/input/mHSC-L/data.csv', help='The input scRNA-seq gene expression file.')
parser.add_argument('--net_file', type=str, default='./demo_data/GRN_inference/input/mHSC-L/label.csv',
...
parser.add_argument('--save_name', type=str, default='./result/mHSC-L')
